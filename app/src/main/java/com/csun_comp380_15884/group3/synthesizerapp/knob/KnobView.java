...
package com.csun_comp380_15884.group3.synthesizerapp.knob;
...
public class KnobView extends View {
  ...
  public KnobView(Context context, AttributeSet attrs) {
    ...
    textHeight_ = 0f * density;  // probably should be set by XML parameter
  ...
  protected void onDraw(Canvas canvas) {
    ...
    paint_.setColor(Color.rgb(214,73,55));
